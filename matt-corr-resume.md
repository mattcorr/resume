...
- Investigate issues for historical trends to detect long-term anomalies.
...
- Design Platform Engineer Solution with ServiceNow & Azure DevOps.
- Collaborate with ServiceNow and Azure Engineers for integration components.
...
**DevOps Guidance**
- Provide Guidance for DevOps best practices and show examples via a demonstration.
- Run a demo of deployments of sample projects to show code quality checks and the deployment process.

---

### MOQdigital
_Solutions Specialist - DevOps_
...
- Define and implement process improvements by automation. Provide assistance for junior staff where required.
- Documented the processes and how-tos for future team members in the wiki.
...
### Mexia
_BizTalk Developer / DevOps Engineer_
...
_BizTalk Developer / BizTalk Support / Tuxedo Middleware Support_
...
**P & O Autogate**
- Object-Oriented Design focused on a workflow-based engine.
...
### QCOM Australia
_Senior Software Engineer / Software Engineer_
...
- Object-Oriented Design focused on a Web-based Front End.
...
- Object-Oriented Design for QNX operating system.
